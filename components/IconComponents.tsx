...
export const Header: React.FC = () => (
    <header className="text-center">
        <div className="bg-white inline-block p-4 rounded-full shadow-md">
             <svg className="w-12 h-12 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-4">Quality Check Photos</h1>
        <p className="mt-2 text-lg text-slate-600">A simple way to capture, analyze, and upload project photos.</p>
    </header>
);
...
export const BarcodeScannerIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15m16.5-15v15M6.75 6v12m4.5-12v12m4.5-12v12m-12-9h12" />
    </svg>
);